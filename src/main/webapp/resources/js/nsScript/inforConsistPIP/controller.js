 ...
 */
try {
    ns('SIGPI.inforConsistPIP.Index.Controller');
    SIGPI.inforConsistPIP.Index.Controller = function () {
        var base = this;
        base.Ini = function () {
            'use strict';
        ...
        base.Event = {
                    ...
                    BootstrapDialog.confirm(base.Parametros.Mensajes.TituloMensajeConfirmacion, base.Parametros.Mensajes.Confirmacion, function (result) {
                        if (result) {
                            var obj = {
                                ...
                                procactual: Web.SIGPI.Parametro.InformeConsistencia,
            ...
            clickbtnAprobar: function () {
                BootstrapDialog.confirm(Web.SIGPI.MensajeSistema.TituloMensajeConfirmacion, 'Está seguro de APROBAR el Proyecto de Informe de consistencia?', function (result) {
                    if (result) {
                        var item = {
                            idproioarr: base.Parametros.codigoNuevoIOARR,
                            idproyepip: base.Parametros.codigoNuevoPIP
        ...
        base.Ajax = {
            ...
            ajaxAprobarPIP: function (data) {
                $.ajax({
                    "url": 'aprobarInformeConsistencia',
                    "type": 'POST',
                    contentType: "application/json",
                    "dataType": 'json',
                    "data": JSON.stringify(data),
            ...
            ajaxGuardarObservacion: function (obj) {
                ...
                $.ajax({
                    "url": 'observarInformeConsistencia',
                    "type": 'POST',
                    contentType: "application/json",
                    "dataType": 'json',
                    "data": JSON.stringify(obj),
