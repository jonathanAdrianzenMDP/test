...
<div class="container-fluid">
        ...
        <div class="col-sm-12">
            ...
            <div class="float-right">
                ...
                <c:if test="${seguimiento.estadoproc eq 72}"><!-- EN ELABORACION -->
                    <button type="button" class="btn btn-primary" name="btnEnviarPIP"><span class="fas fa-paper-plane"></span> Guardar </button> 
    ...
    <div class="card">
        <div class="card-header"  data-toggle="collapse" data-target="#item1">
            <h4 class="mb-0">
        ...
        <div id="item1" class="collapse show">
            <div class="card-body">
                        ...
                        <div class="col-sm-10">
                            <form:select  id="cboCierre" class="form-control" path="CierreInversiones">
                                <c:forEach items="${CierreInversiones}" var="obj">
                                    <option disabled="disabled" <c:if test="${obj.key eq item.proyectoPIP.cierreinv}">selected="selected"</c:if>  value="${obj.key}">${obj.value}</option>
                                </c:forEach>
                            </form:select>
                        </div>
                    </div>
                ...
                <c:if test="${seguimiento.estadoproc eq 41 or seguimiento.estadoproc eq 72 or seguimiento.estadoproc eq 44}"><!-- EN ELABORACION / SIN REGISTROS / OBSERVADO-->
                    <div class="row">
                        <label class="col-sm-2">CIERRE DE INVERSION:</label>                                           
                        <div class="col-sm-10">
                            <form:select id="cboCierre" class="form-control" path="CierreInversiones">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <c:if test="${seguimiento.estadoproc eq 41 or seguimiento.estadoproc eq 72 or seguimiento.estadoproc eq 44}"><!-- EN ELABORACION / SIN REGISTROS-->
                        ...
                        <div class="col-sm-6">   
                            <input type="text" class="form-control text-uppercase" id="txtNamefile" placeholder="Descripción del Archivo" value="doc Liquidacion de Inversion">
                        </div>
