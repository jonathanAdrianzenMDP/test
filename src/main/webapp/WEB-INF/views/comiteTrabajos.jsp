...
<div class="container-fluid">
        ...
        <div class="col-sm-12">
            ...
            <div class="float-right">
                ...
                <c:if test="${seguimiento.estadoproc eq 41 or seguimiento.estadoproc eq 72 or seguimiento.estadoproc eq 44}"><!-- EN ELABORACION / SIN REGISTROS-->
                    ...
                    <button type="button" class="btn btn-primary ml-2" name="btnEnviar" title="Enviar a la Unidad Ejecutora"><span class="fas fa-paper-plane"></span> Enviar</button>
                </c:if> 
                <% }%>
    ...
    <hr>
     <div class="form-group row ">
        ...
        <label class="col-sm-2">Fecha de Entrega de Plan de Trabajo / Documento Equivalente:</label>
        ...
        <div class="col-sm-3">
            <div class="input-group mb-3">
                ...
                <input id="txtFecplatra" class="form-control datepicker" type="text" placeholder="dd/mm/yyyy" aria-describedby="basic-addon2" value="${item.proyectoPIP.fecplatra}">
            </div>
        </div>
    </div>
    <div class="form-group row ">
