...
<div class="container-fluid">
    <div class="row title">
        <div class="col-sm-12 text-center h4">
            ...
            <span class="fas fa-chevron-right"></span><label class="ml-1 text-uppercase">EJECUCION FISICA Y FINANCIERA</label>
        </div>
    ...
    <div class="card mb-1">
        ...
        <div id="item1">
            <div class="card-body">
                ...
                <div class="row">
                    <label class="col-sm-2">PROYECTO DE INVERSION:</label>
                    <div class="col-sm-10">
                    ...
                    <table class="table table-bordered table-md" id="tblInversion">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control number text-right" id="txtrecordin" value="${fuente.recordin}" <c:if test="${seguimiento.estadoproc eq 43}"> disabled="disabled" </c:if> />
                                </td>
                            </tr>
                            <tr>
                                <td>Recursos Directamente Recaudados:</td>
                                <td>
                                    <input type="text" class="form-control number text-right" id="txtrecdirrec" value="${fuente.recdirrec}" <c:if test="${seguimiento.estadoproc eq 43}"> disabled="disabled" </c:if> />
                                </td>
                            </tr>
                            <tr>
                                <td>Recursos de Operaciones Oficiales de Crédito:</td>
                                <td>
                                    <input type="text" class="form-control number text-right" id="txtrecroor" value="${fuente.recroor}" <c:if test="${seguimiento.estadoproc eq 43}"> disabled="disabled" </c:if> />
                                </td>
                            </tr>
                            <tr>
                                <td>Donaciones y Transferencias:</td>
                                <td>
                                    <input type="text" class="form-control number text-right" id="txtrecdontra" value="${fuente.recdontra}" <c:if test="${seguimiento.estadoproc eq 43}"> disabled="disabled" </c:if> />
                                </td>
                            </tr>
                            <tr>
                                <td>Recursos Determinados:</td>
                                <td>
                                    <input type="text" class="form-control number text-right" id="txtrecdeter" value="${fuente.recdeter}" <c:if test="${seguimiento.estadoproc eq 43}"> disabled="disabled" </c:if> />
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <c:if test="${seguimiento.estadoproc eq 41 or seguimiento.estadoproc eq 72 or seguimiento.estadoproc eq 44}"><!-- EN ELABORACION / SIN REGISTROS-->
                        ...
                        <div class="col-sm-6">   
                            <input type="text" class="form-control text-uppercase" id="txtNamefile" placeholder="Descripción del Archivo" value="Doc Ejecucion Fisica y Financiera">
                        </div>
