 ...
 * @author nlarico
 */
@Repository("inforConsistPIPService")
public class InforConsistPIPServiceImplement implements InforConsistPIPService {
    ...
    public Message observar(Observacion item) {
        ...
        try {
            ...
            seguimientoProy.setCodproceso(Constantes.ProcesosPIP_IOARR.InformeConsistencia);
            if(!item.getIDPROIOARR().equals(0)){
