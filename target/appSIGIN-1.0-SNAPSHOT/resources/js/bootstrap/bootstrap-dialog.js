(function (a, b) {
    ...
    a.ZINDEX_BACKDROP = 10040;
    a.ZINDEX_MODAL = 10050;
    a.defaultOptions = {
        id: "",
        type: a.TYPE_PRIMARY,
        size: a.SIZE_NORMAL,
    ...
    a.openAll = function () {
        ...
        initOptions: function (c) {
            ...
            if (this.isRealized()) {
                var c = this; this.getModal().removeClass(a.SIZE_NORMAL).removeClass(a.SIZE_WIDE).removeClass(a.SIZE_LARGE);
        ...
        getDescription: function () {
            ...
            c.append(this.createTitleContent()); c.prepend(this.createCloseButton());
            return c
            ...
            var c = b('<span><i class="close glyphicon glyphicon-remove-sign"></i></span>');
            d.append(c); d.on("click", {
                dialog: this
            }, function (e) {
                e.data.dialog.close()
            }); return d
